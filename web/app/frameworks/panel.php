...
class XCache extends PanelCache {
...
class Dummy extends PanelCache {
    public function get($key) {
        return False;
    }
    public function set($key, $value, $ttl=1) {
...
class FileLogger extends PanelLogger {
    public $file;
